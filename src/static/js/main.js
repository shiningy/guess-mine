...
"use strict";var messages=document.getElementById("jsMessages"),sendMsg=document.getElementById("jsSendMsg"),appendMsg=function(e,n){var s=document.createElement("li");s.innerHTML='\n    <span class="author '.concat(n?"out":"self",'">').concat(n||"You",":</span> ").concat(e,"\n  "),messages.appendChild(s)},handleSendMsg=function(e){e.preventDefault();var n=sendMsg.querySelector("input"),s=n.value;n.value="",appendMsg(s)};sendMsg&&sendMsg.addEventListener("submit",handleSendMsg);
